...
public class dashboardtestcase07 extends storebaseclass{
	
	
	@Test
	public void dashboardtestcase07() throws InterruptedException
	{
			...
			Thread.sleep(6000);
			 ...
			 s.getCmpname().sendKeys(Keys.CONTROL+"a");
			  Thread.sleep(2000);
			    ...
			    a.moveToElement(s.getCancel()).click().perform();
