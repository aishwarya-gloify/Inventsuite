...
public class profiletestcase29 extends profilepage{
	
	@Test
	public void profiletestcase29() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		p.getUserimg().click();
	     ...
	     String data1=f.getExcelData("changepwd", 3, 2);
			String data2= f.getExcelData("changepwd", 3, 3);
