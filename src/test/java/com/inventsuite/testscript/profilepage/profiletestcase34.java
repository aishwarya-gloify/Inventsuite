...
public class profiletestcase34 extends profilepage{
	
	@Test
	public void profiletestcase34() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		p.getUserimg().click();
	     ...
	     String data1=f.getExcelData("changepwd", 9, 2);
		 String data2= f.getExcelData("changepwd", 9, 3);
		 String data3=f.getExcelData("changepwd", 9, 4);
