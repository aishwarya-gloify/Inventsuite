...
public class deletetestcase02 extends brandbaseclass{
	@Test
	public void deletetestcae02() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		b.getYes_delete_btn().click();
		Thread.sleep(3000);
		b.getDelete_success_msg().isDisplayed();
		b.getDelete_ok_btn();
		Thread.sleep(3000);
